...
import 'package:flutter/cupertino.dart' hide CupertinoSlidingSegmentedControl;
...
class SegmentedControl<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _CupertinoSlidingSegmentedControl<T>(
      children: children,
      onValueChanged: onValueChanged,
      groupValue: groupValue,
      thumbColor: AppColors.segmentedControlColor,
      borderColor: AppColors.segmentedControlColor,
      selectedTabColor: AppColors.segmentedControlSelectedText,
      unselectedTabColor: AppColors.segmentedControlDefaultText,
    );
  }
}
...
const Radius _kThumbRadius = Radius.circular(5.0);
...
const double _kMinSegmentedControlHeight = 38.0;
...
class _CupertinoSlidingSegmentedControl<T> extends StatefulWidget {
  final Map<T, Widget> children;
  final T groupValue;
  final ValueChanged<T> onValueChanged;
  ...
  _CupertinoSlidingSegmentedControl({
    ...
    this.selectedTabColor = _kThumbColor,
    this.unselectedTabColor = _kThumbColor,
    this.padding = _kHorizontalItemPadding,
    this.borderColor = CupertinoColors.tertiarySystemFill,
...
class _SegmentedControlState<T>
    extends State<_CupertinoSlidingSegmentedControl<T>>
    with TickerProviderStateMixin<_CupertinoSlidingSegmentedControl<T>> {
  ...
  @override
  void didUpdateWidget(_CupertinoSlidingSegmentedControl<T> oldWidget) {
        ...
        for (final T currentKey in keys) {
          ...
          final Widget child = DefaultTextStyle(
            style: textStyle.copyWith(
                color: currentKey == widget.groupValue
